...
audio-no-devices-desc = No audio devices detected
audio-default-device = Default
audio-set-default = Set as Default
audio-card-profile = Profile
...
wallpaper-unavailable = awww/swww is not installed or the daemon is not running
...
wallpaper-mode = Mode
wallpaper-mode-static = Static
wallpaper-mode-style-tracking = Style Tracking
wallpaper-mode-style-tracking-sub = Follows dark/light mode
wallpaper-mode-day-tracking = Day Tracking
wallpaper-mode-day-tracking-sub = Follows time of day
wallpaper-mode-darkman-unavailable = Dark mode provider unavailable. Install and run darkman to enable style tracking.
wallpaper-current-segment = Current Segment
wallpaper-segment-early-morning = Early Morning (4:30 - 7:30)
wallpaper-segment-morning = Morning (7:30 - 12:00)
wallpaper-segment-afternoon = Afternoon (12:00 - 17:00)
wallpaper-segment-evening = Evening (17:00 - 21:00)
wallpaper-segment-night = Night (21:00 - 1:00)
wallpaper-segment-midnight-oil = Midnight Oil (1:00 - 4:30)
wallpaper-subfolder-hint-style = Expected subfolders: dark/, light/
wallpaper-subfolder-hint-day = Expected subfolders: early-morning/, morning/, afternoon/, evening/, night/, midnight-oil/
...
scheduler-freq-minutely = Every minute
scheduler-freq-every-n-minutes = Every N minutes
scheduler-freq-hourly = Every hour
scheduler-freq-daily = Daily
scheduler-freq-weekly = Weekly
scheduler-freq-monthly = Monthly
scheduler-freq-custom = Custom
scheduler-interval-minutes = Interval (minutes)
scheduler-time-of-day = Time of day
scheduler-days-of-week = Days of the week
scheduler-day-of-month = Day of month
scheduler-custom-expression = Schedule expression (advanced)
scheduler-day-mon = Mon
scheduler-day-tue = Tue
scheduler-day-wed = Wed
scheduler-day-thu = Thu
scheduler-day-fri = Fri
scheduler-day-sat = Sat
scheduler-day-sun = Sun
