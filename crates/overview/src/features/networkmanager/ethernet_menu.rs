...
impl EthernetMenuWidget {
    pub fn new() -> Self {
        ...
        let link_speed_row = DetailRow::new(&crate::i18n::t("network-link-speed"));
        let ipv4_row = DetailRow::new(&crate::i18n::t("network-ipv4-address"));
        let ipv6_row = DetailRow::new(&crate::i18n::t("network-ipv6-address"));
        let subnet_row = DetailRow::new(&crate::i18n::t("network-subnet-mask"));
        let gateway_row = DetailRow::new(&crate::i18n::t("network-gateway"));
