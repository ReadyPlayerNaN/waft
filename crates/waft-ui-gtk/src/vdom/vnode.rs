...
impl VNode {
    ...
    pub fn new<C: Component>(props: C::Props) -> Self {
        Self {
            key: None,
            kind: VNodeKind::Component(make_component_desc::<C>(props, |_| {})),
        }
    }
    ...
    pub fn with_output<C: Component>(
        ...
        Self {
            key: None,
            kind: VNodeKind::Component(make_component_desc::<C>(props, on_output)),
        }
    }
    ...
    pub fn preferences_group(v: VPreferencesGroup) -> Self {
        Self {
            key: None,
            kind: VNodeKind::PreferencesGroup(v),
        }
    }
