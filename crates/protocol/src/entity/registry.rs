    ...
    static REGISTRY: &[EntityTypeInfo] = &[
        ...
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "status",
                    "enum(Active, CredentialsNeeded, NeedsAttention)",
                ...
                prop(
                    "locked",
                    "bool",
                    "Whether the account is administrator-locked",
                ),
            ],
            actions: &[
                action_p(
                    "enable-service",
                    "Enable a specific service on this account",
        ...
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "available",
                    "bool",
                    "Whether the application binary was found",
                ),
            ],
            actions: &[
                ...
                action_p(
                    "open-page",
                    "Launch the application at a specific page",
                    &[req_param(
                        "page",
                        "string",
                        "Page identifier to navigate to",
                    )],
                ),
            ],
        },
        ...
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "sources",
                    "array",
                    "Input sources belonging to this card (excludes monitors)",
                ),
            ],
            actions: &[
                action_p(
                    "set-profile",
                    "Set the card's active profile",
                    &[req_param("profile", "string", "Profile name to activate")],
                ),
                action_p(
                    "set-volume",
                    "Set volume on a sink or source",
                    &[
                ...
                action_p(
                    "toggle-mute",
                    "Toggle mute on a sink or source",
                    &[
                ...
                action_p(
                    "set-default",
                    "Set a sink or source as the default device",
                    &[
                        param("sink", "string", "Sink name (for output)"),
                        param("source", "string", "Source name (for input)"),
                    ],
                ...
                action_p(
                    "set-sink-port",
                    "Change the active port on a sink",
                    &[
                ...
                action_p(
                    "set-source-port",
                    "Change the active port on a source",
                    &[
        ...
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "virtual_device",
                    "bool",
                    "Whether this is a waft-managed virtual device",
                ),
                opt_prop(
                    "sink_name",
                    "string",
            ...
            actions: &[
                ...
                action_p(
                    "create-sink",
                    "Create a virtual null-sink output device",
                    &[
                ...
                action_p(
                    "remove-sink",
                    "Remove a virtual null-sink output device",
                    &[req_param(
                        "sink_name",
                        "string",
                        "Internal sink name to remove",
                    )],
                ),
                action_p(
                    "create-source",
                    "Create a virtual null-source input device",
                    &[
                        req_param(
                            "source_name",
                            "string",
                            "Internal source name (waft_ prefixed)",
                        ),
                        req_param("label", "string", "Human-readable display name"),
                    ],
                ),
                action_p(
                    "remove-source",
                    "Remove a virtual null-source input device",
                    &[req_param(
                        "source_name",
                        "string",
                        "Internal source name to remove",
                    )],
                ),
            ],
        },
        ...
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "device_type",
                    "string",
                    "Device type (e.g. audio-headphones)",
                ),
                prop(
                    "connection_state",
        ...
        EntityTypeInfo {
            ...
            properties: &[prop("active", "bool", "Whether dark mode is active")],
            actions: &[action("toggle", "Toggle dark mode on/off")],
        },
        EntityTypeInfo {
            ...
            properties: &[
                ...
                opt_prop(
                    "auto_location",
                    "bool",
                    "Whether to detect location automatically",
                ),
                ...
                prop(
                    "schema",
                    "object",
                    "Field availability and constraints schema",
                ),
            ],
            actions: &[action("update", "Update automation configuration fields")],
        },
        EntityTypeInfo {
            ...
            properties: &[
                ...
                opt_prop(
                    "connector",
                    "string",
                    "Compositor output connector (e.g. DP-3, eDP-1)",
                ),
            ],
            actions: &[action_p(
                "set-brightness",
        ...
        EntityTypeInfo {
            ...
            properties: &[prop(
                "accent_color",
                "string",
                "Current accent colour (blue, teal, green, yellow, orange, red, pink, purple, slate)",
            )],
            actions: &[action_p(
                "set-accent-color",
                "Set the system accent colour",
                &[req_param(
                    "color",
                    "string",
                    "Accent colour name (blue, teal, green, yellow, orange, red, pink, purple, slate)",
                )],
            )],
        },
        EntityTypeInfo {
            ...
            actions: &[action("toggle", "Toggle night light on/off")],
        },
        EntityTypeInfo {
            ...
            actions: &[action("update", "Update night light configuration fields")],
        },
        EntityTypeInfo {
            ...
            actions: &[
                ...
                action(
                    "random",
                    "Set a random wallpaper from the configured directory",
                ),
                action_p(
                    "update-transition",
                    "Update transition animation parameters",
                    &[
                        param(
                            "transition_type",
                            "string",
                            "Transition type (fade, wipe, grow, etc.)",
                        ),
        ...
        EntityTypeInfo {
            ...
            properties: &[
                ...
                opt_prop(
                    "variant",
                    "string",
                    "XKB variant (comma-separated, parallel to layouts)",
                ),
            ...
            actions: &[
                ...
                action_p(
                    "reorder",
                    "Reorder keyboard layouts",
                    &[req_param("layouts", "array", "Ordered layout codes")],
                ),
                action_p(
                    "set-variant",
                    "Set the XKB variant for a specific layout",
                    &[
                        req_param("layout", "string", "XKB layout code"),
                        req_param(
                            "variant",
                            "string",
                            "XKB variant name (empty string to clear)",
                        ),
                    ],
                ),
                action_p(
                    "rename",
                    "Rename a layout (external-file mode only)",
                    &[
                        req_param("layout", "string", "XKB layout code"),
        ...
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "security_type",
                    "enum(open, wep, wpa, wpa2, wpa3, enterprise)",
                    "Encryption type",
                ),
                prop(
                    "connecting",
                ...
                opt_prop(
                    "autoconnect",
                    "bool",
                    "Whether to connect automatically when in range",
                ),
                opt_prop(
                    "metered",
                    "enum(Unknown, Yes, No, GuessYes, GuessNo)",
                    "Metered connection state",
                ),
                opt_prop("dns_servers", "Vec<string>", "Configured DNS servers"),
                opt_prop(
                    "ip_method",
                    "enum(Auto, Manual, LinkLocal, Disabled)",
            ...
            actions: &[
                action(
                    "connect",
                    "Connect to this network. Params: {password?: string}",
                ),
        ...
        EntityTypeInfo {
            ...
            properties: &[prop("active", "bool", "Whether DND is active")],
            actions: &[action("toggle", "Toggle Do Not Disturb")],
        },
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "resident",
                    "bool",
                    "Whether the notification persists after action",
                ),
        ...
        EntityTypeInfo {
            ...
            properties: &[prop("active", "bool", "Whether recording is active")],
            actions: &[action("toggle", "Toggle notification recording on/off")],
        },
        // ── notification_filter ──
        EntityTypeInfo {
            ...
            properties: &[prop("profile_id", "string", "ID of the active profile")],
            actions: &[action_p(
                "set",
        ...
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "default_low",
                    "string",
                    "Sound for low-urgency notifications",
                ),
                prop(
                    "default_normal",
                    "string",
                    "Sound for normal-urgency notifications",
                ),
                prop(
                    "default_critical",
                    "string",
                    "Sound for critical-urgency notifications",
                ),
            ],
            actions: &[action("update", "Update sound configuration")],
        },
        // ── notification_sound ──
        EntityTypeInfo {
            ...
            actions: &[
                action_p(
                    "add-sound",
                    "Add a sound file to the gallery",
                    &[
                ...
                action_p(
                    ...
                    &[req_param(
                        "reference",
                        "string",
                        "Sound reference (e.g. sounds/alert.ogg)",
                    )],
                ),
            ],
        },
        ...
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "state",
                    "enum(available, running, stopped, failed)",
        ...
        EntityTypeInfo {
            ...
            properties: &[prop("active", "bool", "Whether sleep inhibition is active")],
            actions: &[action("toggle", "Toggle sleep inhibition")],
        },
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "description",
                    "string",
                    "Human-readable description from unit file",
                ),
                prop(
                    "active_state",
                    "string",
                    "Current state (active/inactive/activating/deactivating/failed)",
                ),
                prop("enabled", "bool", "Whether the unit starts on login"),
                prop(
                    "sub_state",
                    "string",
                    "Detailed sub-state (e.g. running/dead/exited)",
                ),
            ],
            actions: &[
        ...
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "schedule",
                    "ScheduleKind",
                    "Timer schedule (calendar or relative)",
                ),
                opt_prop(
                    "last_trigger",
                    "i64",
                    "Unix timestamp of last trigger (seconds)",
                ),
                opt_prop(
                    "next_elapse",
                    "i64",
                    "Unix timestamp of next scheduled trigger (seconds)",
                ),
                opt_prop("last_exit_code", "i32", "Exit code of the last service run"),
                prop(
                    "command",
                    "string",
                    "Command executed by the associated service",
                ),
                opt_prop(
                    "working_directory",
                    "string",
                ...
                prop(
                    "after",
                    "Vec<string>",
                    "Units this timer's service orders itself after",
                ),
                prop(
                    "restart",
        ...
        EntityTypeInfo {
            ...
            actions: &[action("toggle", "Toggle the backup method on/off")],
        },
        // ── weather ──
        EntityTypeInfo {
            ...
            properties: &[
                ...
                prop(
                    "condition",
                    "enum(Clear, PartlyCloudy, Cloudy, Fog, Drizzle, Rain, FreezingRain, Snow, Thunderstorm)",
                    "Weather condition",
                ),
        ...
        EntityTypeInfo {
            ...
            actions: &[action(
                "focus",
                "Focus the window and bring it to the center",
            )],
        },
    ];
