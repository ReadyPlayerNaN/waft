...
use crate::store::ItemLifecycle;
use crate::types::{NotificationAction, NotificationIcon};

// Stub for trigger_window_resize - plugins don't have direct access to main window
