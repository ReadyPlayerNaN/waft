...
use waft_plugin_api::WidgetFeatureToggle;
use waft_plugin_api::ui::feature_toggle::FeatureToggleOutput;
                ...
                | FeatureToggleOutput::Deactivate => {
                    ...
                    glib::spawn_future_local(async move {
                        if enabled {
                            ...
                            if let Some(nm) = nm {
                                match crate::runtime_bridge::spawn_on_tokio(async move {
                            ...
                            match crate::runtime_bridge::spawn_on_tokio(dbus::disconnect_device_sendable(
                                dbus.clone(),
                                device_path.clone(),
                            ))
                            .await
